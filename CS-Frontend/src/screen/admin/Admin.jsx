...
const Admin = () => {
  ...
  const [menuItems, setMenuItems] = useState([
    { label: "Courses", state: false },
    { label: "Batches", state: false },
    { label: "Projects", state: false },
    { label: "Images", state: false },
    { label: "Events", state: false },
  ]);
  ...
  return (
    <>
      <div
        className={`fixed top-0 left-0 h-full w-64 bg-blue-600  text-white font-bold transition-all duration-500 ease-in-out overflow-auto`}
      >
        <Link
          to="/"
        ...
        >
          <img
            src="https://ik.imagekit.io/lna8p52h8/Connect%20Shiksha%20Logo.png?updatedAt=1716901764457"
            alt=""
            className="h-full w-full p-2 bg-white rounded-md"
          />
          Admin Panel
        </Link>
