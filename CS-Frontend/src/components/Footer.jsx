...
const Footer = () => {
  return (
    <>
      <div>
        <footer className="bg-gray-900 lg:pt-10">
          <div className="container p-6 mx-auto">
            <div className="lg:flex">
              <div className="w-full -mx-6 lg:w-2/5">
                <div className="px-6">
                  <a href="#">
                    <img className="w-auto h-20" src={mainlogo} alt="" />
                  </a>

                  <p className="max-w-sm mt-2 text-white ">
                    Connect-Shiksha, a community dedicated to providing
                    teaching, learning, and guidance to students in rural areas.
                  </p>
              ...
              <div className="mt-6 lg:mt-0 lg:flex-1">
                <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 ">
                  ...
                  <div>
                    ...
                    <span className="block mt-2 text-sm text-white dark:text-gray-400 hover:underline">
                      connectsikshaofficial@email.com
                    </span>
                    <div className="flex items-center text-2xl  mt-7 text-white">
                      <a
            ...
            <div>
              <p className="text-center text-white">
                © connect Shiksha 2024 - All rights reserved
              </p>
            </div>
          </div>
        </footer>
